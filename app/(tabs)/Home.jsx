    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        <View style={styles.modalBackdrop}>
          <View className="bg-[#1e1e32] border-2 border-[#ff8353] rounded-2xl w-4/5 p-5 shadow-lg items-center">
          
            <Text className="text-white text-2xl text-center" style={styles.Home_text}>Leaving so soon?</Text>
