    ...
    return (
        <SafeAreaView className="flex-1">
            ...
            <LinearGradient className='flex-1 px-3' colors={['#151527', '#0e1636', '#ff8353']} start={{ x: 0.5, y: 0 }} end={{ x: 0.5, y: 1 }}>
                <View>
                    <View className="flex-row justify-between items-center gap-3 mt-5 mb-6">
...
const styles = StyleSheet.create({
    ...
    totalContainer: { marginTop: 20, paddingTop: 15, borderTopWidth: 2, borderTopColor: 'white',marginBottom: 150   },
